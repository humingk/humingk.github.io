...
movie_all_tags=[
    ...
    "2018","2017","2010年代","2000年代","90年代","80年代","70年代","60年代","更早","经典","青春","文艺","搞笑","励志","魔幻","感人","女性","黑帮"
]
...
#获取随机useragents
def get_random_UserAgents():
    return random.choice(UserAgents)

#不带Host和cookie的header
header={
    "User-Agent": get_random_UserAgents(),
